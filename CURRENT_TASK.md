...
Notification delivery Settings controls are complete. Settings > Appearance now persists default-off desktop notification delivery plus a daily quiet window. OS notification scheduling/delivery remains unimplemented until the candidate selector and click-through routing are added.
